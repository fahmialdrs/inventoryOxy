<p>
	Dear {{ $ujiriksas->customer->nama }},
</p>

<p>
	Dengan ini kami ingin memberikan informasi mengenai tabung dengan nomer pendaftaran uji <b>{{ $ujiriksas->no_registrasi }} </b> telah terjadi perubahan, silahkan melakukan pengecekan kembali pada attachment berikut.<br>
	<br>
