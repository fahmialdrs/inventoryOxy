        ...
        <tr>
            ...
            <td>
                <div class="{{ $errors->has('tube_id') ? ' has-error' : '' }}">
                    <input id="tube_id" type="text" class="" name="tvisualresult[{{ $a }}][tube_id]" value="{{ $t->tube->no_tabung or old('tube_id') }}" disabled>
                    {!! $errors->first('tube_id', '<p class="help-block">:message</p>') !!}
                </div>
            </td>
            <td>
                <div class="{{ $errors->has('jumlah_barang') ? ' has-error' : '' }}">
                    <input id="jumlah_barang" type="text" class="" name="tvisualresult[{{ $a }}][jumlah_barang]" value="{{ $t->jumlah_barang or old('jumlah_barang') }}" disabled>
            ...
            <td>
                <div class="{{ $errors->has('nama_barang') ? ' has-error' : '' }}">
                    <input id="nama_barang" type="text" class="" name="tvisualresult[{{ $a }}][nama_barang]" value="{{ $t->nama_barang or old('nama_barang') }}" disabled>
            ...
            <td>
                <div class="{{ $errors->has('keluhan') ? ' has-error' : '' }}">
                    <input id="keluhan" type="text" class="" name="tvisualresult[{{ $a }}][keluhan]" value="{{ $t->keluhan or old('keluhan') }}" disabled>
            ...
            <td>
                <input type="file" name="fotovisual[{{ $a }}][foto_tabung_visual]" multiple>
